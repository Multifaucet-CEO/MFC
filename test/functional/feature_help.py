...
"""Verify that starting multicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start multicoin with -h for help text")
        ...
        self.log.info("Start multicoin with -version for version information")
        ...
        self.log.info("Start multicoind with -fakearg to make sure it does not start")
