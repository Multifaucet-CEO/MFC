...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " multicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  multicoin-tx [options] <hex-tx> [commands]  Update hex-encoded multicoin transaction\n" +
            "or:     multicoin-tx [options] -create [commands]   Create hex-encoded multicoin transaction\n" +
            "\n";
