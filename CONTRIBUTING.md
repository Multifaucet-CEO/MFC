Contributing to Multicoin Core
============================

The Multicoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Multicoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/multicoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to multicoin-qt
...
The following applies to code changes to the Multicoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Multicoin
Network Protocol consensus changes.

Whether a pull request is merged into Multicoin Core rests with the project merge
...
Patches that change Multicoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Multicoin consensus, it must have been
...
The project leader is the release manager for each Multicoin Core release.
