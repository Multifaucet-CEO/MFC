# Support for Output Descriptors in Multicoin Core

Since Multicoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `muc1...` for mainnet or `tmuc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Multicoin Core wallets, a convenience function `combo` is
