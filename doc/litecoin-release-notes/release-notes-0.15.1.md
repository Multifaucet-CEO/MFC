Multicoin Core version *0.15.1* is now available from:

  <https://download.multicoin.org/multicoin-0.15.1/>
...
A number of changes to the way Multicoin Core deals with peer connections and invalid blocks
